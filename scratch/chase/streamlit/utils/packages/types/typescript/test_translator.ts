...
assert(enumTranslator.racePhaseStringToEnum("RACING") === RacePhase.RACING, "Case insensitive RacePhase");
...
assert(enumTranslator.itemStringToEnum("triple_red_shells") === Item.TRIPLE_RED_SHELLS, "Triple shells");
